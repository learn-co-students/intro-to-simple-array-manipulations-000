describe "manipulating arrays" do
  ...
  context 'push method' do
    ...
    it "adds an element to the end of an array" do
      answer = countries_in_western_africa << next_country # replace the underscore with your answer
  ...
  context "flatten method" do
    ...
    it "returns a new array that is a combination of two or more arrays" do
      answer = private_colleges_in_newyork.concat(military_academies_in_newyork) # replace the underscore with your answer
